...
.card-headinge {
  background: url(https://www.iperiusbackup.net/wp-content/uploads/2016/05/1768.sql_logo.png) top left/cover no-repeat;
  width: 29.1%;
  display: table-cell;
}
.card-headingee {
...
<body>
    ...
    <div class="page-wrapper  p-t-180 p-b-100 font-robo">
        <div class="wrapper wrapper--w960">
            <div class="card card-2">
                ...
                <div class="card-body">
                    <h2 class="title" style="color: orange;">MY SQL</h2>
                    
                        <div class="input-group">
                            <input class="input--style-2 js-datepicker" type="text" value='${mysqldefaulthost}' name = "mysqlhost" placeholder = "Host"  id="lineHeight">
                            <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
                        </div>
                        <div class="row row-space">
                                <div class="input-group">
                                    <input type="number" value='${mysqldefaultport}' name = "mysqlport" placeholder = "Port"  id="paddingBottom">
                                   
                                    <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
                                   
                                </div>
                                <div class="input-group">
                                    <input  type="text" value='${mysqldefaultdb}' placeholder = "DB NAME" name = "mysqldb"  id="paddingTop" />
                                    <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
                                </div>

                                <div class="input-group">
                                    
                                    <input type="text" value='${mysqldefaultdb2}' placeholder = "DB 2 name" name = "mysqldb2"  id="paddingTop" />
                                    <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
                                </div>
                                <div class="input-group">
                                    
                                    <input type="text" value="${mysqldefaultusername}" placeholder = "Username" name = "mysqlusername"  id="lineHeight" />
                                    <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
                                </div>
                                <div class="input-group">
                                    
                                    <input type="password" value = "${mysqldefaultpassword}" placeholder="Password" name = "mysqlpassword"  id="paddingTop" />
                                    <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
                                </div>
    ...
    <div class="page-wrapper  p-t-180 p-b-100 font-robo">
        <div class="wrapper wrapper--w960">
            <div class="card card-2">
                <div class="card-headinge"></div>
                <div class="card-body">
                    <h2 class="title" style="color: orange;">SQL Server</h2>
                    
                        <div class="input-group">
                            <input class="input--style-2 js-datepicker" type="text" value='${sqlserverdefaulthost}' name = "sqlserverhost" placeholder = "Host"  id="lineHeight">
                            <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
                        ...
                        <div class=" row-space">
                                ...
                                <div class="input-group">
                                    <input type="number" value='${sqlserverdefaultport}' name = "sqlserverport" placeholder = "Port"  id="paddingBottom">
                                   
                                    <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
                                   
                                </div>
                                <div class="input-group">
                                    <input  type="text" value='${sqlserverdefaultdb}' placeholder = "DB NAME" name = "sqlserverdb"  id="paddingTop" />
                                    <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
                                </div>

                                <div class="input-group">
                                    
                                    <input type="text" value='${sqlserverdefaultdb2}' placeholder = "DB 2 name" name = "sqlserverdb2"  id="paddingTop" />
                                    <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
                                </div>
                                <div class="input-group">
                                    
                                    <input type="text" value = "${sqlserverdefaultusername}"placeholder = "Username" name = "sqlserverusername"  id="lineHeight" />
                                    <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
                                </div>
                                <div class="input-group">
                                    
                                    <input type="password" value = "${sqlserverdefaultpassword}" placeholder="Password" name = "sqlserverpassword"  id="paddingTop" />
                                    <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
                                </div>
    ...
    <div class="page-wrapper  p-t-180 p-b-100 font-robo">
        <div class="wrapper wrapper--w960">
            <div class="card card-2">
                <div class="card-headingee"></div>
                <div class="card-body">
                    <h2 class="title" style="color: orange;">Access</h2>
                    
                        <div class="input-group">
                            <input class="input--style-2 js-datepicker" type="text" value = "${defaultaccesspath}" name = "accesspath" placeholder="Enter Access Database path" id="exampleInputAccess1">
                            <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
    ...
    <br><br>
             <div class="col-md-12 text-center">
                <button type="submit" class="btn btn-dark" style="background-color: orange; ;">click me if you done</button>
                </div>
