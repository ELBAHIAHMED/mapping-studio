...
<body style="background-image: url(https://www.teahub.io/photos/full/257-2579582_wallpaper-linear-orange-gradient-blue-dark-orange-medium.jpg); background-size: cover;">
  <div class="topnav">
...
<div class="card-group" style = "margin-top : 10% ;">
  <div class="card" style = "border: none; background-color: blue ;">
    <img class="card-img-top"   src="https://www.technoworldnews.com/wp-content/uploads/2016/11/MS-Access-To-MySQL.jpg" alt="Card image cap">
  ...
  <div class="card" style = "border: none;">
    <img class="card-img-top" src="http://geeks.ms/access/wp-content/uploads/sites/78/2016/05/SServerAccess.png"  alt="Card image cap">
    <div class="card-body" style="background-color: orange;">
  ...
  <div class="card" style = "border: none; width: 500px; max-width: 100%; height: auto">
    <img class="card-img-top" src="https://1.bp.blogspot.com/-sTw-g90gPFw/WOHxcJPVkOI/AAAAAAAAAr4/yRbB3WgR5ZAbPuOl-y4mggQ89xeyilqNwCLcB/s1600/SQL%2BServer%2B%2526%2BMySQL.jpg"style="width: 500px; max-width: 100%; height: auto" alt="Card image cap">
    <div class="card-body" style="background-color: orange;">
  ...
  <div class="card" style = "border: none;">
    <img class="card-img-top" src="https://cdn.shortpixel.ai/client/q_glossy,ret_img,w_1500/https://www.singlemindconsulting.com/wp-content/uploads/2020/08/how-to-use-mysql-views-as-entities-for-drupal-views.jpg" alt="Card image cap">
    <div class="card-body" style="background-color: orange;">
