...
<table class="table" value = "${table.sqlservertable}*${table.accesstable}" id = "table${count}">
  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col" style="background-color: orange;">SQLServer : ${table.sqlservertable}</th>
      <th scope="col" style="background-color: #299fe4;">Access : ${table.accesstable}</th>
  ...
  <c:forEach var = "sqlserverfield" items = "${table.sqlserverfields}">
  	 ...
  	 <th scope="row" style="color: white;" value = "${sqlserverfield}" id = "${count}th${co}"><c:out value="${sqlserverfield}"/></th>
