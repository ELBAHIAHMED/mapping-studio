...
<table class="table" value = "${table.mysqltable}*${table.sqlservertable}" id = "table${count}">
  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col" style="background-color: orange;">MySQL : ${table.mysqltable}</th>
      <th scope="col" style="background-color: #299fe4;">SQLServer : ${table.sqlservertable}</th>
  ...
  <c:forEach var = "mysqlfield" items = "${table.mysqlfields}">
  	 ...
  	 <th scope="row" style="color: white;" value = "${mysqlfield}" id = "${count}th${co}"><c:out value="${mysqlfield}"/></th>
