...
<table class="table">
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col" style="background-color: #299fe4;" >SQLServer tables</th>
  ...
  <c:forEach var = "mysqltable" items = "${mysqltables}">
    <tr id = "${count}" value ="workplz">
      ...
      <option value = "No Mapping" style="background-image: url(https://www.teahub.io/photos/full/257-2579582_wallpaper-linear-orange-gradient-blue-dark-orange-medium.jpg);">No Mapping</option>
