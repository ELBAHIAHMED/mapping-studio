...
<table class="table">
  <thead class="thead-dark">
    <tr>
      <th scope="col" style="background-color: orange;">SQLServer tables</th>
  ...
  <c:forEach var = "sqlservertable" items = "${sqlservertables}">
    <tr id = "${count}" value ="workplz">
      ...
      <th scope="row" style="color: white;" id = "th${count}" value = "${sqlservertable}"><c:out value="${sqlservertable}"/></th>
